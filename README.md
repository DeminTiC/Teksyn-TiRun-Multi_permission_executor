...
> ⚠️ **警告**：高权限可能损坏系统或带来安全风险，请在理解权限作用后谨慎使用。建议仅在测试环境或系统维护场景下使用。
...
```powershell
# 保存为 Teksyn.ps1
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/your-repo/Teksyn/main/Teksyn.ps1" -OutFile Teksyn.ps1
```
...
- [NtObjectManager](https://github.com/google/gears) 项目作者（Google Project Zero）提供了强大的 Windows NT 对象管理能力。
